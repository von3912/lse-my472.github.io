---
title: "Introductory quantitative text analysis"
...
```{r}
#just count the number of characters
...
```{r}
#comes as the documents and 2 doc variables
exemplary_corpus
```
...
```{r}
#docvars: year, president, firstName, party
...
#so Reagan and Roosevelt talked about unemployment a lot --> prob due to great depression
```
...
#stopwords, if we took 'the economy' for example, we would get an empty space (' the economy')--> use padding to leave the space
