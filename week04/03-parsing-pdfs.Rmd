...
```{r}
#install.packages("tesseract") #original from Google, open-source, print no
...
#would get a PDF error--> 609 pages, 'character'
...
Again, we can transform the output into a corpus and continue from there (e.g. with tokenisation and creating a dfm):
