...
<<<<<<< HEAD:week03/04-exercise-visualisation.Rmd
...
>>>>>>> b18561a3c26c1bca2d2d4edd90513aa67e5ff60b:week03/04-exercises-visualisation.Rmd

#create your base plot, you define the mapping)
yrng <- range(unemp$unemp, na.rm = TRUE)

#as_date--> for an object (we need a column and table)#
...
p <- ggplot(data = unemp, aes(x = date, y = unemp))
p + geom_line()

<<<<<<< HEAD:week03/04-exercise-visualisation.Rmd
# Fix axes and add colored rectangles
p.labs <- p + labs(x = "Party of Presdient", y = "Unemployment Rate")
p.labs + geom_line()
=======
...
ggplot(unemp, aes(x = date, y = unemp)) +
